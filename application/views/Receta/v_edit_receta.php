...
<div class="container-fluid">
    <input type="hidden" name="ID_RECETA" id="ID_RECETA" value="<?= $this->session->userdata("recetaIDs")["receta"] ?>">
    <div class="row">
        <div class="col-sm-12 col-mdx-12 col-lg-12 text-center">
            <br>
            <div class="panel panel-primary">
                <div class="panel-heading text-left header-primary">
                    <div class="panel-title text-left"><span class="heading-primary">Editar Receta</span>
                ...
                <div class="panel-body">
                    ...
                    <button id="PrintReceta"  class="btn btn-success float-right save">
