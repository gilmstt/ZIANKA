            ...
            <div class="panel panel-primary">
                <div class="panel-heading header-primary">
                    <div class="panel-title text-left">
                        <span class="heading-primary"><i class="fas fa-file-invoice"></i> URGENCIAS</span>
                    </div>
                </div>
                <div class="panel-body">
                    <form id="formSearchUrgencias" method="POST">
                        <!-- Tarifas y fecha -->
                        <div class="row text-left">
                            <div class="col-md-3 text-left">
                                <div class="form-group">
                                    <label class="control-label text-left">Fecha incio</label>
                                    <div class='input-group date' id='fechaInicio'>
                                        <span class="input-group-addon">Desde</span>
                                        <input type="text" data-type="datepicker" name="RG_FECHA_INICIAL" required readonly="" id="RG_FECHA_INICIAL"
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class='input-group date' id='fechaInicio'>
                                        ...
                                        <input type="text" data-type="datepicker" name="RG_FECHA_FINAL" required readonly="" id="RG_FECHA_FINAL" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-lg-4 text-left">
                                <div class="form-group">
                                    <label for="BUSCAR_POR" class="control-label text-left" style="color: #9C27B0;">Buscar por</label>
                        ...
                        <div class="row text-left">
                            ...
                            <div id="opcion_buscar" class="col-lg-2">
                                <div class="form-group">
                            ...
                            <tbody id="tbody_reportes" style="font-size: 14px; letter-spacing: 0.5px;">
                                ...
                                if ($entries) {
                                    foreach ($entries as $entry) {
                                        $tar_mem = '<label style="color: #ff0000;">SIN ASIGNAR</style>';
                                        if (isset($entry['NOMBRE_TARIFA']))
                                            $tar_mem = $entry['NOMBRE_TARIFA'];
                                        if (isset($entry['NOMBRE_MEMBRESIA']))
                                            $tar_mem = $entry['NOMBRE_MEMBRESIA'];
                                        ?>
                                        <tr>
                                            <td><?= $entry['NOMBRE_PACIENTE'] ?></td>
                                            <td><?= $entry['NOMBRE_USUARIO'] ?></td>
                                            <td><?= $tar_mem ?></td>
                                            <td><?= $entry['MOTIVO_URGENCIA'] ?></td>
                                            <td><?= $entry['FECHA_URGENCIA'] ?></td>
                                            <td><?= $entry['HORA_URGENCIA'] ?></td>
                                        </tr>
                                        <?php
                                    }
                                }
