                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class=" row col-sm-12 col-mdx-12 col-lg-12"><br>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="EXPOSICION_SOLAR"
                                                id="EXPOSICION_SOLAR_SI" value="1"
                                                <?= ($ROW_DATA_PATIENT->EXPOSICION_SOLAR == 1) ? 'checked' : '' ?>>
                                            <label class="form-check-label" for="EXPOSICION_SOLAR_SI">SÍ</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="EXPOSICION_SOLAR"
                                                id="EXPOSICION_SOLAR_NO" value="0"
                                                <?= ($ROW_DATA_PATIENT->EXPOSICION_SOLAR === "0" || $ROW_DATA_PATIENT->EXPOSICION_SOLAR === 0) ? 'checked' : '' ?>>
                                            <label class="form-check-label" for="EXPOSICION_SOLAR_NO">NO</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-mdx-6 col-lg-6">
                                        <label class="control-label text-left"> TIEMPO DE EXPOSICIÓN SOLAR:</label>
                                        <input type="text" class="form-control form-control-sm" name="TIEMPO_EXPOSICION_SOLAR" rows="1"
                                            value="<?= htmlspecialchars(isset($ROW_DATA_PATIENT->TIEMPO_EXPOSICION_SOLAR) ? $ROW_DATA_PATIENT->TIEMPO_EXPOSICION_SOLAR : '') ?>">
                                    </div>
                                </div>
                                ...
                                <div class=" row col-sm-12 col-mdx-12 col-lg-12"><br>
                                    ...
                                    <div class="col-sm-2 col-mdx-2 col-lg-2">
                                        <input class="form-check-input" type="radio" name="USO_PROTECTOR_SOLAR"
                                            id="USO_PROTECTOR_SOLAR_SI" value="1"
                                            <?= ($ROW_DATA_PATIENT->USO_PROTECCION_SOLAR == 1) ? 'checked' : '' ?>>
                                    ...
                                    <div class="col-sm-2 col-mdx-2 col-lg-2">
                                        <input class="form-check-input" type="radio" name="USO_PROTECTOR_SOLAR"
                                            id="USO_PROTECTOR_SOLAR_NO" value="0"
                                            <?= ($ROW_DATA_PATIENT->USO_PROTECCION_SOLAR === 0 ) || ($ROW_DATA_PATIENT->USO_PROTECCION_SOLAR === "0") ? 'checked' : '' ?>>
                                    ...
                                    <div class="col-sm-3 col-mdx-3 col-lg-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="MARCA_PROTECTOR_SOLAR"
                                            value="<?= htmlspecialchars(isset($ROW_DATA_PATIENT->MARCA_PROTECTOR_SOLAR) ? $ROW_DATA_PATIENT->MARCA_PROTECTOR_SOLAR : '') ?>">
                                    </div>
                                    <div class="col-sm-3 col-mdx-3 col-lg-3">
                                        <label class="control-label text-left">FPS:</label>
                                        <input type="text" class="form-control form-control-sm" name="FPS_PROTECTOR_SOLAR" value="<?= htmlspecialchars(isset($ROW_DATA_PATIENT->FPS_PROTECTOR_SOLAR) ? $ROW_DATA_PATIENT->FPS_PROTECTOR_SOLAR : '') ?>">
                                    </div>
                                </div>

                                <?php if ($this->session->userdata('CAREYES_ID_USUARIO') == ADMINISTRADOR || $this->session->userdata('CAREYES_ID_USUARIO') == MEDICO): ?>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="DIABETES_MELLITUS"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->DIABETES_MELLITUS === "0" || $ROW_DATA_PATIENT->DIABETES_MELLITUS === 0) ? 'checked' : '' ?>>
                                    ...
                                    <div class="form-check">
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="HIPERTENSION_ARTERIAL"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->HIPERTENSION_ARTERIAL === 0 || $ROW_DATA_PATIENT->HIPERTENSION_ARTERIAL === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    value="0"
                                                    <?= ($ROW_DATA_PATIENT->ENFERMEDADES_ENDOCRINOLOGICAS === 0 || $ROW_DATA_PATIENT->ENFERMEDADES_ENDOCRINOLOGICAS === "0") ? 'checked' : '' ?>>
                                                <label class="form-check-label"
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="ENFERMEDADES_PSIQUIATRICAS"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->ENFERMEDADES_PSIQUIATRICAS === 0 || $ROW_DATA_PATIENT->ENFERMEDADES_PSIQUIATRICAS === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="ENFERMEDADES_AUTOINMUNES"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->ENFERMEDADES_AUTOINMUNES === 0 || $ROW_DATA_PATIENT->ENFERMEDADES_AUTOINMUNES === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="VIH" id="VIH_NO" value="0"
                                                    <?= ($ROW_DATA_PATIENT->VIH === 0 || $ROW_DATA_PATIENT->VIH === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="HERPES_LABIAL"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->HERPES_LABIAL === 0 || $ROW_DATA_PATIENT->HERPES_LABIAL === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="TRANSFUSIONES_SANGUINEAS"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->TRANSFUSIONES_SANGUINEAS === 0 || $ROW_DATA_PATIENT->TRANSFUSIONES_SANGUINEAS === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="FRACTURAS" id="FRACTURAS_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->FRACTURAS === 0 || $ROW_DATA_PATIENT->FRACTURAS === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="HOSPITALIZACIONES"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->HOSPITALIZACIONES === 0 || $ROW_DATA_PATIENT->HOSPITALIZACIONES === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="CIRUGIAS_PREVIAS"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->CIRUGIAS_PREVIAS === 0 || $ROW_DATA_PATIENT->CIRUGIAS_PREVIAS === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="HEPATITIS" id="HEPATITIS_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->HEPATITIS === 0 || $ROW_DATA_PATIENT->HEPATITIS === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="CANCER" id="CANCER_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->CANCER === 0 || $ROW_DATA_PATIENT->CANCER === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="EPILEPSIA" id="EPILEPSIA_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->EPILEPSIA === 0 || $ROW_DATA_PATIENT->EPILEPSIA === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12"><br>
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="ALERGIAS" id="ALERGIAS_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->ALERGIAS === 0 || $ROW_DATA_PATIENT->ALERGIAS === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="FUMA" id="FUMA_NO" value="0"
                                                    <?= ($ROW_DATA_PATIENT->FUMA === 0 || $ROW_DATA_PATIENT->FUMA === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="ADICCIONES"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->ADICCIONES === 0 || $ROW_DATA_PATIENT->ADICCIONES === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="BEBE_ALCOHOL"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->BEBE_ALCOHOL === 0 || $ROW_DATA_PATIENT->BEBE_ALCOHOL === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="FOBIA" id="FOBIA_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->FOBIA === 0 || $ROW_DATA_PATIENT->FOBIA === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="DESMAYOS" id="DESMAYOS_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->DESMAYOS === 0 || $ROW_DATA_PATIENT->DESMAYOS === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="ASPIRINA" id="ASPIRINA_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->ASPIRINA === 0 || $ROW_DATA_PATIENT->ASPIRINA === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="MORETES" id="MORETES_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->MORETES === 0 || $ROW_DATA_PATIENT->MORETES === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="BRONCEADO" id="BRONCEADO_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->BRONCEADO === 0 || $ROW_DATA_PATIENT->BRONCEADO === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="ANESTESIA" id="ANESTESIA_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->ANESTESIA === 0 || $ROW_DATA_PATIENT->ANESTESIA === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="PROBLEMA_ANESTESIA"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->PROBLEMA_ANESTESIA === 0 || $ROW_DATA_PATIENT->PROBLEMA_ANESTESIA === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="INMUNIZACION"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->INMUNIZACION === 0 || $ROW_DATA_PATIENT->INMUNIZACION === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="INFECCION_PIEL"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->INFECCION_PIEL === 0 || $ROW_DATA_PATIENT->INFECCION_PIEL === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-1 col-md-1 col-lg-1">
                                                <input class="form-check-input" type="radio" name="ESTEROIDES"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->ESTEROIDES === 0 || $ROW_DATA_PATIENT->ESTEROIDES === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="EJERCICIO" id="EJERCICIO_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->EJERCICIO === 0 || $ROW_DATA_PATIENT->EJERCICIO === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="DIETA" id="DIETA_NO"
                                                    value="0" <?= ($ROW_DATA_PATIENT->DIETA === 0 || $ROW_DATA_PATIENT->DIETA === "0") ? 'checked' : '' ?>>
                                        ...
                                        <div class="row col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="col-sm-2 col-md-2 col-lg-2">
                                                <input class="form-check-input" type="radio" name="ACTUALMENTE_EMBARAZADA"
                                                    ...
                                                    <?= ($ROW_DATA_PATIENT->ACTUALMENTE_EMBARAZADA === 0 || $ROW_DATA_PATIENT->ACTUALMENTE_EMBARAZADA === "0") ? 'checked' : '' ?>>
